...
export async function POST(req: Request) {
    try {
      ...
      const API_REQUESTS_URL = `https://workflowplatform.azurewebsites.net/request-tools/WER/workflow-types/${Constants.WORKFLOW_TYPE_ID}/configuration`;//process.env.API_REQUESTS_URL;
      console.log('api requests workflow type config url value : ' , API_REQUESTS_URL);
      if (!API_REQUESTS_URL) {
      ...
      // console.log('body before the call : ', JSON.stringify(bodypost));
      ...
      console.log('flow response pa Text : ', paText);
