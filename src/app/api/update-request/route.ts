...
export async function POST(req: Request) {
    try {
      ...
      const { instancename, requestid, bodyrequest } = body ?? {};
      ...
      console.log('InstanceName before the call update request : ', instancename);
      console.log('RequestId before the call update request : ', requestid);
